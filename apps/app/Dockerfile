...
ARG BUILD_BUNNY_STREAM_LIBRARY_ID="123456"
ARG BUILD_BUNNY_STREAM_API_KEY="build-stream-api-key"
ARG BUILD_BUNNY_STREAM_PULL_ZONE_HOSTNAME="vz-example.b-cdn.net"
ARG BUILD_BUNNY_STREAM_WEBHOOK_SECRET="build-stream-webhook-secret"
...
RUN DATABASE_URL="$BUILD_DATABASE_URL" \
  ...
  BUNNY_STREAM_LIBRARY_ID="$BUILD_BUNNY_STREAM_LIBRARY_ID" \
  BUNNY_STREAM_API_KEY="$BUILD_BUNNY_STREAM_API_KEY" \
  BUNNY_STREAM_PULL_ZONE_HOSTNAME="$BUILD_BUNNY_STREAM_PULL_ZONE_HOSTNAME" \
  BUNNY_STREAM_WEBHOOK_SECRET="$BUILD_BUNNY_STREAM_WEBHOOK_SECRET" \
  npm run build
